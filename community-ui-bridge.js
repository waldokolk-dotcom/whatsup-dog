(()=>{
  ...
  function loadCommunityTools(){
    ...
    const script=document.createElement('script');
    script.src='./community-tools.js?v=1.6.2';
    script.async=false;
  ...
  function loadUiHotfix(){
    ...
    const script=document.createElement('script');
    script.src='./ui-hotfix-1.6.2.js?v=1';
    script.async=false;
  ...
  loadDialogUi();
  import('./version.js?v=1.6.2').catch(err=>console.warn('Versiecontroller kon niet laden',err));
  import('./mobile-ui.js?v=1.6.2').catch(err=>console.warn('Mobiele UI kon niet laden',err));
