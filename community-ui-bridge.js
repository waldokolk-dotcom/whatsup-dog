(()=>{
  ...
  function loadCommunityTools(){
    ...
    const script=document.createElement('script');
    script.src='./community-tools.js?v=1.7.1';
    script.async=false;
  ...
  loadDialogUi();
  import('./version.js?v=1.7.1').catch(err=>console.warn('Versiecontroller kon niet laden',err));
  import('./mobile-ui.js?v=1.7.1').catch(err=>console.warn('Mobiele UI kon niet laden',err));
