...
for(const file of ['mobile-ui.js','profile-ui.js','dialog-ui.js','community-tools.js','ui-hotfix-1.6.2.js','report-photo.js']) execFileSync(process.execPath,['--check',file]);
...
console.log(`PASS Mobile UX Agent v${version} stability and report photo flow`);
