...
const stabij=Array.from(breedCatalog).find(x=>x.name==='Stabijhoun (Friese Stabij)');assert.ok(stabij,'Stabijhoun / Friese Stabij missing');assert.ok(Array.from(stabij.aliases).includes('Stabijhoun'),'Stabijhoun alias missing');assert.ok(Array.from(stabij.aliases).includes('Friese Stabij'),'Friese Stabij alias missing');assert.ok(stabij.popular,'Stabijhoun should be marked popular');assert.ok(Array.from(breedCatalog).find(x=>x.name==='Labrador Retriever')?.popular,'Popular breed marker missing');assert.ok(Array.from(breedCatalog).find(x=>x.name==='Australian Shepherd')?.popular,'Official popular breed marker missing');
