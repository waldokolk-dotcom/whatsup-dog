...
const CORE=['./vendor/leaflet/leaflet.js','./vendor/leaflet/leaflet.css','./vendor/leaflet/images/layers.png','./vendor/leaflet/images/layers-2x.png','./vendor/leaflet/images/marker-icon.png','./icon-192.png','./icon-512.png','./','./index.html','./styles.css?v=6','./breed.css?v=2','./home.css?v=5','./app.js?v=7','./official-areas.js?v=9','./home.js?v=5','./smart-report.css?v=3','./smart-report-v3.js?v=3','./backend-config.js?v=4','./community-backend.js?v=2','./community-ui-bridge.js?v=1','./dialog-ui.js?v=3','./profile-ui.js?v=1','./directory-ui.js?v=1','./community-tools.js?v=1.7.0','./ui-hotfix-1.6.2.js?v=2','./version.js?v=1.7.0','./mobile-ui.js?v=1.7.0','./report-lifecycle.js?v=1','./report-photo.js?v=1.7.0','./breed-catalog.js?v=2','./manifest.webmanifest','./icon.svg','./waldo-mark.png','./data/nijkerk-losloopgebieden.geojson'];
