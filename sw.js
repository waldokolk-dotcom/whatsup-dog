...
const CACHE=PREFIX+'v42';
const CORE=['./vendor/leaflet/leaflet.js','./vendor/leaflet/leaflet.css','./vendor/leaflet/images/layers.png','./vendor/leaflet/images/layers-2x.png','./vendor/leaflet/images/marker-icon.png','./icon-192.png','./icon-512.png','./','./index.html','./styles.css?v=6','./design-system.css?v=1.9.1','./production-feed.css?v=1','./paw-wheel.css?v=1','./breed.css?v=2','./home.css?v=5','./app.js?v=7','./production-feed.js?v=1','./paw-wheel.js?v=1','./official-areas.js?v=9','./home.js?v=5','./smart-report.css?v=3','./smart-report-v3.js?v=3','./backend-config.js?v=4','./community-backend.js?v=2','./species-context.js?v=1.9.1','./community-ui-bridge.js?v=1','./dialog-ui.js?v=3','./profile-ui.js?v=1','./directory-ui.js?v=1.9.0','./community-tools.js?v=1.9.1','./ui-hotfix-1.6.2.js?v=2','./version.js?v=1.9.1','./mobile-ui.js?v=1.9.1','./report-lifecycle.js?v=1.9.1','./report-photo.js?v=1.7.0','./breed-catalog.js?v=2','./install-guide.js?v=1.9.1','./manifest.webmanifest','./icon.svg','./waldo-mark.png','./data/nijkerk-losloopgebieden.geojson'];
