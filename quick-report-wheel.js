...
const fab=document.createElement('button');fab.type='button';fab.id='wdQuickReport';fab.className='wd-quick-report';fab.innerHTML='<span class="wd-dock-center" aria-hidden="true">🐾</span>';fab.setAttribute('aria-label','Open half zichtbaar meldwiel');
